...
import { AadhraImage, documentButtonClick, uploadCabImage, uploddocfaild } from '../../module/actions';
...
const DriverLicense = () => {
        ...
        ImagePicker.showImagePicker(options, (response) => {
            if (response.didCancel) {
                ...
                let imagedata = {
                  ...
                  dispatch(uploadCabImage(imagedata))
            }})
    }
    ...
    return (
        ...
        <View style={{ flex: 1 }}>
            ...
            <Text style={styles.labelText}>Upload Cab Image</Text>
