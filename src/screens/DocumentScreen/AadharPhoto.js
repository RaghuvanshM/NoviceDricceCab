...
import { AadhraImage, documentButtonClick, drivingLicense, profilPhoto, uploddocfaild } from '../../module/actions';
    ...
    const onChoosePhotoClick = () => {
        ...
        ImagePicker.showImagePicker(options, (response) => {
            if (response.didCancel) {
                ...
                dispatch(AadhraImage(imagedata))
    ...
    return (
        <Fragment>
            ...
            <View style={{ flex: 1 }}>
                ...
                <Text style={styles.labelText}>Upload Aadhar Image</Text>
